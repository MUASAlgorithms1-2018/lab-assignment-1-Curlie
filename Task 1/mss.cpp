//
// Created by julian on 11.10.18.
//

#include "mss.h"
#include <iostream>

int cubic_mss(int array[], int end) {
    int maxSum = 0;
    int thisSum = 0;
    for (int i = 0; i < end; i++) {
        for (int j = i; j < end; j++) {
...
int quadratic_mss(int array[], int end){
    int maxSum = 0;
    int thisSum = 0;
    for(int i = 0; i < end; i++){
        thisSum = 0;
...
int linear_mss(int array[], int end){
    int maxSum = 0;
    int thisSum = 0;
    for(int i = 0; i< end; i++){
...
/*
    //9
    static int arr1[] = {1, 2, -30, 4, 5};
    int size = sizeof(arr1) / sizeof(int);
    int result = 0;
    result = cubic_mss(arr1, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr1, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr1, size);
    std::cout << result << std::endl;

    //0
    static int arr2[] = {-1, -3, -10, -40, -1, 0, -100};
    size = sizeof(arr2) / sizeof(int);
    result = 0;
    result = cubic_mss(arr2, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr2, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr2, size);
    std::cout << result << std::endl;

    //25
    static int arr3[] = {1, 2, 3, 4, 5, 10};
    size = sizeof(arr3) / sizeof(int);
    result = 0;
    result = cubic_mss(arr3, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr3, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr3, size);
    std::cout << result << std::endl;
    ...
    result = 0;
    result = cubic_mss(arr4, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr4, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr4, size);
    std::cout << result << std::endl;

    //17
    static int arr5[] = {3, 13, -7, 8, -20, 1, 12};
    size = sizeof(arr5) / sizeof(int);
    result = 0;
    result = cubic_mss(arr5, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr5, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr5, size);
    std::cout << result << std::endl;

    //4
    static int arr6[] = {1, -1, 2, -2, 3, -3, 4, -4};
    size = sizeof(arr6) / sizeof(int);
    result = 0;
    result = cubic_mss(arr6, size);
    std::cout << result << std::endl;
    result = 0;
    result = quadratic_mss(arr6, size);
    std::cout << result << std::endl;
    result = 0;
    result = linear_mss(arr6, size);
    std::cout << result << std::endl;
    */